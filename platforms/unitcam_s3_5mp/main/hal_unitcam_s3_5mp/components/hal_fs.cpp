...
void HAL_UnitCamS3_5MP::_log_out_system_config()
{
    ...
    printf(
        ...
        "zone: "
        "%s\n",
        _data.config.wifiSsid.c_str(), _data.config.wifiPass.c_str(), _data.config.startPoster.c_str(),
        _data.config.waitApFirst.c_str(), _data.config.nickname.c_str(), _data.config.postInterval,
